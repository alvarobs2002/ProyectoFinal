...
?>
<a href="carrito.php" class="btn-flotante" id="btnCarrito">Carrito <span class="badge bg-success" id="carrito"><?php echo $_SESSION["contadorCarrito"]; ?></span></a>
...
?>
 <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <div class="container px-4 px-lg-5">
        ...
        <?php
    $query = mysqli_query($conexion, "SELECT p.*, c.id_categoria AS id_cat, c.categoria FROM productos p INNER JOIN categorias c ON c.id_categoria = p.id_categoria WHERE c.categoria = '$catnom'");
    $result=mysqli_num_rows($query);
    if ($result > 0) {
        while ($data = mysqli_fetch_assoc($query)) { ?>
