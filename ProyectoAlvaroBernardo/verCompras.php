    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Sus compras</h1>
                <p class="lead fw-normal text-white-50 mb-0">Aquí podrá ver todos los productos que ha comprado.</p>
            </div>
        </div>
    </header>
    <section class="py-5">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive">
                        ...
                        ON compras.id_producto = productos.id WHERE nombreUsuario='$nomUsu';");
